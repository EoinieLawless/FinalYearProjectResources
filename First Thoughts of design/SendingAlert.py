...
#DO NOT REMOVE FONTS, FONTFACE IS REQUIRED FOR OPENCV2
# Font type.
...
# Beginning of initializing Media pose 
...
if __name__ == "__main__":
    ...
    # Name for video input/ Will switch to the camera when sprint 2 comes 
    ...
    # Meta. All info needed for output Video
    fps = int(cap.get(cv2.CAP_PROP_FPS))
    width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
    height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
    frame_size = (width, height)
    fourcc = cv2.VideoWriter_fourcc(*'mp4v') #Change for video type
...
# ---------------------------------------------------------------------------------------------
        ...
        # Let's use y - coordinate of P3 100px above x1,  for display elegance.
        # Although we are taking y = 0 while calculating angle between P1,P2,P3.
        cv2.circle(image, (left_Shoulder_x, left_Shoulder_y - 100), 7, yellow, -1 )# The -1 is for the angle
        cv2.circle(image, (r_shldr_x, r_shldr_y), 7, pink, -1)
        cv2.circle(image, (l_hip_x, l_hip_y), 7, yellow, -1)

        # you can use any value for y, not necessarily 100 or 200 pixels.
        ...
        if neck_inclination < 40 and torso_inclination < 10:
            ...
            # Putting info on the screen display
            ...
            # Join landmarks - They will turn green for the posture
            ...
            # Join landmarks - They will turn red for the posture
        ...
        # If you stay in bad posture for more than 10 seconds (10s) send an alert.
        if bad_time > 10:
            sendWarning()
        # Write frames.
